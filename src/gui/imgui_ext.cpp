...
bool ImGui::DragUInt32(const char* label, unsigned int* v, float v_speed, unsigned int v_min, unsigned int v_max, const char* format, ImGuiSliderFlags flags)
{
...
bool ImGuizmo::Manipulate(OPERATION operation, MODE mode, float* matrix, float* deltaMatrix, const float* snap, const float* localBounds, const float* boundsSnap)
{
...
static int imGuizmoID;

void ImGuizmo::ResetGlobalID()
{
    imGuizmoID = 2000;
}

void ImGuizmo::UniqueID()
{
