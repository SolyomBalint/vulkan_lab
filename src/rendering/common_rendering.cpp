...
DescriptorSetBuilder& DescriptorSetBuilder::addBinding(uint32_t binding, vk::DescriptorType type, vk::ShaderStageFlags stages, vk::Sampler* pImmutableSampler)
{
...
DescriptorSetBuilder& DescriptorSetBuilder::setMaximumSetCount(uint32_t count)
{
    mMaxSetCount = count;
    return *this;
}
