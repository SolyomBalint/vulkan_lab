...
int main() {
    ...
    std::cout << "Current working directory is " << wd << std::endl;
    if (!fs::exists(cDirShaderSources)) {
        std::cout << "It seems to be that the application was started in the wrong directory. Make sure it is started from the 'wd' folder.\n";
    }
